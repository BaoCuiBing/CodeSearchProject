<template>
    <div class="app-container">
        <div class="content-wrapper" :class="{ 'grayscale-mode': isGrayscale }">
...
import { messageApi, systemApi } from '@/assets/app_request_api.js'
...
const loadSpecialMode = async () => {
    try {
        const data = await systemApi.getSpecialMode()
        isGrayscale.value = data?.enabled || false
    } catch (e) { /* 忽略 */ }
}
